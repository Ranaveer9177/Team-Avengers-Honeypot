...
ssh-keygen -t rsa -b 2048 -f ssh_keys/server.key -N "" -C "honeypot@localhost" 2>/dev/null
sudo chmod 666 ssh_keys/server.key
...
python3 src/unified_honeypot.py &
sleep 2

print_status "Starting Dashboard..."
export FLASK_RUN_PORT=5001
python3 src/unified_dashboard.py &
sleep 2
