...
Environment Variables (optional):
    ...
    DASHBOARD_PASSWORD    Dashboard password (default: Honeypot@9177)
...
# Password defaults to Honeypot@9177 in app.py
if (-not $env:DASHBOARD_PASSWORD) { $env:DASHBOARD_PASSWORD = "Honeypot@9177" }
